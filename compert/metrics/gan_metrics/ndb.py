...
class NDB:
    def __init__(self, training_data=None, number_of_bins=100, significance_level=0.05, z_threshold=None,
        ...
        """
        self.number_of_bins = number_of_bins  # Coarsness
        self.significance_level = significance_level
        self.z_threshold = z_threshold  # Threshold to determine a hit
        ...
        self.cached_results = {}
        # Can create a cache folder where you store the bin calculation (avoid repetition)
    ...
    def construct_bins(self, training_samples, bins_file):
        ...
        """
        # number of examples x number of dimensions 
        n, d = training_samples.shape
        # Bins adefine resolution 
...
if __name__ == "__main__":
    ...
    # Get a set of training samples and fit the NBD class
