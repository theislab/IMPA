...
# Simple implementation of an AlexNet with a cache containing activations 
...
class LPIPS(nn.Module):
    def __init__(self):
        ...
        # Append 1x1 convolutions to a single feature map from channels of AlexNet
    ...
    def _load_lpips_weights(self):
        # Parametrize the model with lpips pre-trained weights 
        own_state_dict = self.state_dict()
        if torch.cuda.is_available():
            state_dict = torch.load('/home/icb/alessandro.palma/imCPA/compert/metrics/lpips_weights.ckpt')
        else:
            state_dict = torch.load('/home/icb/alessandro.palma/imCPA/compert/metrics/lpips_weights.ckpt',
    ...
    def forward(self, x, y):
        ...
        # Apply AlexNet to both and derive feature maps 
        ...
        for x_fmap, y_fmap, conv1x1 in zip(x_fmaps, y_fmaps, self.lpips_weights):
            ...
            # Subtract them, take the squared power, apply convolution 1x1
...
def calculate_lpips_given_images(group_of_images):
    ...
    # calculate the average of pairwise distances among all couples of outputs 
